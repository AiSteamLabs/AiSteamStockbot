...
export function StockChart({ symbol, comparisonSymbols, locale ="en" }: { symbol: string, comparisonSymbols: ComparisonSymbolObject[], locale: string  }) {
      ...
      >
        ...
        <div className="tradingview-widget-copyright">
          <a
            ...
            target="_blank"
          >
            <span className="">Track all markets on Steambot</span>
          </a>
        </div>
      </div>
    </div>
