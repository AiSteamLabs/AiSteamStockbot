...
function IconSteam({ className, ...props }: React.ComponentProps<'img'>) {
  return (
    <img
      src="/logo-steam.svg"
      alt="Steam Logo"
...
function IconArrowLeft ({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M34.34 133.66l72-72a8 8 0 0 1 11.32 11.32L59.31 120H216a8 8 0 0 1 0 16H59.31l58.35 58.34a8 8 0 0 1-11.32 11.32l-72-72a8 8 0 0 1 0-11.32Z" />
    </svg>
  );
}
